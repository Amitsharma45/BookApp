...
function About() {
    return (
        <div className="container" id="about-container">
            ...
            <p id="para">
                BookApp is developed as a part of our training and played the role of our capstone project. BookApp is a library catalog, that was developed with the help of <a href="https://openlibrary.org/developers/api" target="blank">Open Library API</a>, with the ultimate goal of making all the published works of humankind available to everyone in the world. While large in scope and ambition, we hope we were able to develop something fruitful.
                <br /><br />
